...
;(function ($, window, document, undefined) {
  var pluginName = "countdown360",
    defaults = {
      ...
      fontSize: 40,             // the font size, dynamically calulated if omitted in options
      fontWeight: 700,                 // the font weight
      autostart: true,                 // start the countdown automatically
      seconds: 60,                     // the number of seconds to count down
      label: ["minutes", "minutes"],    // the label to use or false if none
  ...
  Plugin.prototype = {
    ...
    {
      return  Math.round((new Date().getTime() - this.startedAt.getTime())/60000);
    },
    extendTimer: function (value) {
      var seconds = parseInt(value),
          secondsElapsed = Math.round((new Date().getTime() - this.startedAt.getTime())/60000);
    ...
    addSeconds: function (value) {
      var secondsElapsed = Math.round((new Date().getTime() - this.startedAt.getTime())/60000);
