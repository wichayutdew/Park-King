...
exports.createReserve = function() {
   ...
   this.reserveMqttUser = null;
   this.reserveMqttPass = null;
   this.reserveMqttPort = null;
...
exports.Reserve = function(connection,platenumber, username, floor, slot, buildingname, reserveid){
  var request = new Request('INSERT INTO dbo.Reserve (PlateNumber,Username,Floor,Slot,BuildingName,QRCodeIn,QRCodeOut,Time_In,Time_Out,reserveID,hasPaid,reserveStatus) VALUES (@platenumber,@username,@floor,@slot,@buildingname,@qrcodein,@qrcodeout,@time_in,@time_out,@reserveid,@haspaid,@reservestatus)',
